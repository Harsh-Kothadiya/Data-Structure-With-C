...
void insertGivenNode(struct node**,int,int);
void deleteFirst(struct node**);
void deleteLast(struct node**);
void deleteGivenNde(struct node**,int);
...
void insertFirst(struct node **Start,int val)
{
    struct node *tmp;
...
void insertLast(struct node **Start,int val)
{
    struct node *traval;
    struct node *tmp;
    tmp=(struct node*)malloc(sizeof(struct node));
...
void insertGivenNode(struct node **Start,int val1,int val2)
{
    struct node *traval;
...
void deleteGivenNde(struct node **Start,int val)
{
   struct node *traval;
